(define (domain composition)
	...
	(:constants s0_handler_cleaning_0 - state s1_handler_film_deposition_0 - state s2_handler_resist_coating_0 - state s3_handler_exposure_0 - state s4_handler_development_0 - state s5_handler_etching_0 - state)
	(:types state action qstate)
	(:predicates (current_state_0 ?s - state) (current_state_1 ?s - state) (current_state_2 ?s - state) (current_state_3 ?s - state) (current_state_4 ?s - state) (current_state_5 ?s - state) (cleaning) (development) (etching) (exposure) (film_deposition) (resist_coating) (startsymb) (oldautstate ?q - qstate) (newautstate ?q - qstate) (world_mode) (trans_mode) (sync_mode) (dummy_goal))
	(:action startaction
	...
	(:action cleaning_0_handler_cleaning_0
		...
		:effect (and (current_state_0 s0_handler_cleaning_0) (cleaning) (trans_mode) (not (development)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (resist_coating)) (not (world_mode)))
	)
	(:action development_4_handler_development_0
		...
		:effect (and (current_state_4 s4_handler_development_0) (development) (trans_mode) (not (cleaning)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (resist_coating)) (not (world_mode)))
	)
	(:action etching_5_handler_etching_0
		:precondition (and (current_state_5 s5_handler_etching_0) (world_mode) (not (startsymb)))
		:effect (and (current_state_5 s5_handler_etching_0) (etching) (trans_mode) (not (cleaning)) (not (development)) (not (exposure)) (not (film_deposition)) (not (resist_coating)) (not (world_mode)))
	)
	(:action exposure_3_handler_exposure_0
		:precondition (and (current_state_3 s3_handler_exposure_0) (world_mode) (not (startsymb)))
		:effect (and (current_state_3 s3_handler_exposure_0) (exposure) (trans_mode) (not (cleaning)) (not (development)) (not (etching)) (not (film_deposition)) (not (resist_coating)) (not (world_mode)))
	)
	(:action film_deposition_1_handler_film_deposition_0
		...
		:effect (and (current_state_1 s1_handler_film_deposition_0) (film_deposition) (trans_mode) (not (cleaning)) (not (development)) (not (etching)) (not (exposure)) (not (resist_coating)) (not (world_mode)))
	)
	(:action resist_coating_2_handler_resist_coating_0
		...
		:effect (and (current_state_2 s2_handler_resist_coating_0) (resist_coating) (trans_mode) (not (cleaning)) (not (development)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (world_mode)))
	)
	...
	(:action trans_aut_q9_t46
		:precondition (and (trans_mode) (oldautstate q9) )
		:effect (and (newautstate q9) (dummy_goal))
	)
	(:action trans_aut_q10_t47
		:precondition (and (trans_mode) (oldautstate q10) )
		:effect (newautstate q2)
	)
	(:action start_sync
		:precondition (and (trans_mode) )
		:effect (and (sync_mode) (not (trans_mode)) (not (oldautstate q0)) (not (oldautstate q1)) (not (oldautstate q2)) (not (oldautstate q3)) (not (oldautstate q4)) (not (oldautstate q5)) (not (oldautstate q6)) (not (oldautstate q7)) (not (oldautstate q8)) (not (oldautstate q9)) (not (oldautstate q10)))
	)
	(:action sync_q0_pos
	...
	(:action continue
		:precondition (and (sync_mode) (not (newautstate q0)) (not (newautstate q1)) (not (newautstate q2)) (not (newautstate q3)) (not (newautstate q4)) (not (newautstate q5)) (not (newautstate q6)) (not (newautstate q7)) (not (newautstate q8)) (not (newautstate q9)) (not (newautstate q10)))
