(define (domain composition)
	...
	(:constants s0_handler_cleaning_0 - state s1_handler_film_deposition_0 - state s2_handler_resist_coating_0 - state)
	(:types state action qstate)
	(:predicates (current_state_0 ?s - state) (current_state_1 ?s - state) (current_state_2 ?s - state) (cleaning) (film_deposition) (resist_coating) (startsymb) (oldautstate ?q - qstate) (newautstate ?q - qstate) (world_mode) (trans_mode) (sync_mode) (dummy_goal))
	(:action startaction
	...
	(:action cleaning_0_handler_cleaning_0
		...
		:effect (and (current_state_0 s0_handler_cleaning_0) (cleaning) (trans_mode) (not (film_deposition)) (not (resist_coating)) (not (world_mode)))
	)
	(:action film_deposition_1_handler_film_deposition_0
		...
		:effect (and (current_state_1 s1_handler_film_deposition_0) (film_deposition) (trans_mode) (not (cleaning)) (not (resist_coating)) (not (world_mode)))
	)
	(:action resist_coating_2_handler_resist_coating_0
		...
		:effect (and (current_state_2 s2_handler_resist_coating_0) (resist_coating) (trans_mode) (not (cleaning)) (not (film_deposition)) (not (world_mode)))
	)
	...
	(:action trans_aut_q6_t16
		:precondition (and (trans_mode) (oldautstate q6) )
		:effect (and (newautstate q6) (dummy_goal))
	)
	(:action trans_aut_q7_t17
