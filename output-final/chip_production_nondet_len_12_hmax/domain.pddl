...
(:action packaging_11_handler_packaging_0
    :precondition (and (not (startsymb)) (current_state_11 s11_handler_packaging_0))
    :effect (and
        (oneof
...
(:action repair_10_handler_testing_broken
    :precondition (and (not (startsymb)) (current_state_10 s10_handler_testing_broken))
    :effect (and
...
(:action repair_11_handler_packaging_broken
    :precondition (and (not (startsymb)) (current_state_11 s11_handler_packaging_broken))
    :effect (and
            (and (not (current_state_11 s11_handler_packaging_broken)) (current_state_11 s11_handler_packaging_0))
        (repair)
        (not (activation))
        (not (assembly))
        (not (cleaning))
...
(:action testing_10_handler_testing_0
    :precondition (and (not (startsymb)) (current_state_10 s10_handler_testing_0))
    :effect (and
        (oneof
