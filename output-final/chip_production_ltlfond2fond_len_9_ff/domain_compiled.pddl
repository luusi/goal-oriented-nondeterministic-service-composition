(define (domain composition)
	...
	(:predicates (current_state_0 ?s - state) (current_state_1 ?s - state) (current_state_2 ?s - state) (current_state_3 ?s - state) (current_state_4 ?s - state) (current_state_5 ?s - state) (current_state_6 ?s - state) (current_state_7 ?s - state) (current_state_8 ?s - state) (activation) (cleaning) (development) (etching) (exposure) (film_deposition) (impurities_implantation) (resist_coating) (resist_stripping) (startsymb) (oldautstate ?q - qstate) (newautstate ?q - qstate) (world_mode) (trans_mode) (sync_mode) (dummy_goal))
	(:action startaction
	...
	(:action activation_7_handler_activation_0
		...
		:effect (and (current_state_7 s7_handler_activation_0) (activation) (trans_mode) (not (cleaning)) (not (development)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (impurities_implantation)) (not (resist_coating)) (not (resist_stripping)) (not (world_mode)))
	)
	(:action cleaning_0_handler_cleaning_0
		:precondition (and (current_state_0 s0_handler_cleaning_0) (world_mode) (not (startsymb)))
		:effect (and (current_state_0 s0_handler_cleaning_0) (cleaning) (trans_mode) (not (activation)) (not (development)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (impurities_implantation)) (not (resist_coating)) (not (resist_stripping)) (not (world_mode)))
	)
	(:action development_4_handler_development_0
		...
		:effect (and (current_state_4 s4_handler_development_0) (development) (trans_mode) (not (activation)) (not (cleaning)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (impurities_implantation)) (not (resist_coating)) (not (resist_stripping)) (not (world_mode)))
	)
	(:action etching_5_handler_etching_0
		:precondition (and (current_state_5 s5_handler_etching_0) (world_mode) (not (startsymb)))
		:effect (and (current_state_5 s5_handler_etching_0) (etching) (trans_mode) (not (activation)) (not (cleaning)) (not (development)) (not (exposure)) (not (film_deposition)) (not (impurities_implantation)) (not (resist_coating)) (not (resist_stripping)) (not (world_mode)))
	)
	(:action exposure_3_handler_exposure_0
		:precondition (and (current_state_3 s3_handler_exposure_0) (world_mode) (not (startsymb)))
		:effect (and (current_state_3 s3_handler_exposure_0) (exposure) (trans_mode) (not (activation)) (not (cleaning)) (not (development)) (not (etching)) (not (film_deposition)) (not (impurities_implantation)) (not (resist_coating)) (not (resist_stripping)) (not (world_mode)))
	)
	(:action film_deposition_1_handler_film_deposition_0
		...
		:effect (and (current_state_1 s1_handler_film_deposition_0) (film_deposition) (trans_mode) (not (activation)) (not (cleaning)) (not (development)) (not (etching)) (not (exposure)) (not (impurities_implantation)) (not (resist_coating)) (not (resist_stripping)) (not (world_mode)))
	)
	(:action impurities_implantation_6_handler_impurities_implantation_0
		...
		:effect (and (current_state_6 s6_handler_impurities_implantation_0) (impurities_implantation) (trans_mode) (not (activation)) (not (cleaning)) (not (development)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (resist_coating)) (not (resist_stripping)) (not (world_mode)))
	)
	(:action resist_coating_2_handler_resist_coating_0
		...
		:effect (and (current_state_2 s2_handler_resist_coating_0) (resist_coating) (trans_mode) (not (activation)) (not (cleaning)) (not (development)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (impurities_implantation)) (not (resist_stripping)) (not (world_mode)))
	)
	(:action resist_stripping_8_handler_resist_stripping_0
		...
		:effect (and (current_state_8 s8_handler_resist_stripping_0) (resist_stripping) (trans_mode) (not (activation)) (not (cleaning)) (not (development)) (not (etching)) (not (exposure)) (not (film_deposition)) (not (impurities_implantation)) (not (resist_coating)) (not (world_mode)))
	)
	...
	(:action trans_aut_q3_t6
		:precondition (and (trans_mode) (oldautstate q3) (cleaning) (resist_stripping) )
		:effect (newautstate q3)
	)
	...
	(:action trans_aut_q4_t16
		:precondition (and (trans_mode) (oldautstate q4) (film_deposition) (resist_stripping) )
		:effect (newautstate q4)
	)
	...
	(:action trans_aut_q6_t36
		:precondition (and (trans_mode) (oldautstate q6) (exposure) (resist_stripping) )
		:effect (newautstate q6)
	)
	(:action trans_aut_q6_t37
		:precondition (and (trans_mode) (oldautstate q6) (exposure) (resist_coating) )
		:effect (newautstate q6)
	)
	(:action trans_aut_q6_t38
		:precondition (and (trans_mode) (oldautstate q6) (exposure) (impurities_implantation) )
		:effect (newautstate q6)
	)
	(:action trans_aut_q6_t39
